# pk-speak — spoken-reply mode

Paste the block below into your project `AGENTS.md` or `~/.codex/AGENTS.md` to enable
spoken-reply rules. This snippet also applies to oh-my-pi, which uses the same
AGENTS.md / markdown-config path.
