...
| `openai-realtime-live.ts` | OpenAI-Realtime / HF S2S adapter; connect URL from `PI_SPEAK_OPENAI_REALTIME_URL` / `SPEECH_TO_SPEECH_URL` / `PI_SPEAK_S2S_URL`, defaulting to `ws://localhost:8765/v1/realtime`. |
